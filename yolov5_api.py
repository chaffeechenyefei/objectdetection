...
from models.yolo import Model ,Model_yolov5x6, Detect
...
def load_yolo_model(cfg='./models/yolov5s.yaml', weights='./weights/yolov5s.pt', singleOutput=False, preTrained=False):
    ...
    if preTrained:
        if weights.endswith('.pth'):
            ...
            print('attempt_load...')
            yolo_net_adv = attempt_load(weights, map_location='cpu')
            return yolo_net_adv
    else:
        yolo_net.eval()
    return yolo_net
